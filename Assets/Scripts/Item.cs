...
public class Item : IEquatable<Item>
{
    ...
    public int amountOfFactory { get; }    //공장 한칸에 넣을 수 있는 아이템 최대개수
    ...
    public Item(string _name, int _uniqueKey, Dimension _dimension, StaffWork _workType, int _price, int _amountOfShelf, int _amountOfWarehouse, int _amountOfFactory, Sprite _sprite)
    {
        name = _name;
        ...
        amountOfFactory = _amountOfFactory;
        sprite = _sprite;
    }
    ...
    public Item(Item item, int _amount = 0)
    {
        ...
        amountOfFactory = item.amountOfFactory;
        sprite = item.sprite;
